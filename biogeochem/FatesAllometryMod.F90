...
contains
  ...
  subroutine CheckIntegratedAllometries(dbh,ipft,crowndamage, branch_frac, &
...
!      bsap =  hbl2bsap/(la_per_sa_int + h*la_per_sa_slp) * (h/agb_fraction) * bleaf
  ...
  ! =====================================================================================
subroutine ForceDBH( ipft, canopy_trim, d, h, bdead, bl, crowndamage, crown_reduction, branch_frac )
