...
contains
  ...
  subroutine CheckIntegratedAllometries(dbh,ipft,icrowndamage,branch_frac, canopy_trim, &
     ...
     real(r8),intent(in) :: branch_frac ! fraction of aboveground biomass in branches
