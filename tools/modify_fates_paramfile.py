...
def main():
    ...
    try:
        ...
        for i in range(ndim_file):
            ...
            elif var.dimensions[i] in ['fates_history_age_bins','fates_history_size_bins','fates_history_coage_bins','fates_history_height_bins','fates_NCWD','fates_litterclass','fates_leafage_class','fates_damage_class', 'fates_prt_organs','fates_hydr_organs','fates_variants']:
        ...
        if args.changeshape:
            ...
            if length_specified != otherdimlength:
                ...
                plastic_dimensions_list = ['fates_history_age_bins','fates_history_size_bins','fates_history_coage_bins','fates_history_height_bins','fates_leafage_class', 'fates_damage_class']
