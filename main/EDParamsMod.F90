module EDParamsMod
   ...
   real(r8),protected,allocatable :: ED_val_history_coageclass_bin_edges(:)
   ...
   character(len=param_string_length),parameter :: ED_name_history_coageclass_bin_edges= "fates_history_coageclass_bin_edges"
