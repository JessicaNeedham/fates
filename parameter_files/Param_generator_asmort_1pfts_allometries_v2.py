...
d2h = np.linspace(0.55, 2.0, num=10)
...
for i in range(0,10) :
    ...
    for j in range(0,10) :
        ...
        fileout = os.path.join('onepft_ensembles', 'fates_params_asmort_1pft_allom_v2_%d.nc'  % (n))                                                                                                                                                          
        pft = 1
        fin = fileout
        ...
        modp.main(var = var, pft = pft, fin = 'onepft_ensembles/fates_params_asmort_1pft_allom_v2_1.nc',
